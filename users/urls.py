...
urlpatterns = [
    ...
    path(
        "coordinador/reporte-diario/",
        views.reporte_asistencia_diaria,
        name="reporte_asistencia_diaria",
    ),
    path(
        "coordinador/reporte-mensual/",
        views.reporte_asistencia_mensual,
        name="reporte_asistencia_mensual",
    ),
